...
class BaldaApp:
    ...
    def show_modes(self):
        ...
        box = tk.LabelFrame(frame, text="Размер поля", padx=20, pady=20, bg=PANEL_COLOR, fg=DARK_GREEN, highlightbackground="#bbf7d0", highlightthickness=2)
        box.pack(pady=20)
    ...
    def create_left_panel(self, parent):
        ...
        letter_box = tk.LabelFrame(left, text="Выбранная буква", padx=5, pady=5, bg=PANEL_COLOR, fg=DARK_GREEN, highlightbackground="#bbf7d0", highlightthickness=1)
        letter_box.pack(fill=tk.X, pady=4)
        tk.Label(letter_box, textvariable=self.letter_var, font=self.big_font, width=4, bg=PANEL_COLOR, fg=ACCENT).pack()
        self.button(letter_box, "Сбросить ход", self.cancel_turn, width=14).pack(pady=4)
        self.action_box = tk.LabelFrame(left,text="Ход Игрока 1",padx=5,pady=5,bg=PANEL_COLOR,fg=DARK_GREEN,highlightbackground="#bbf7d0",highlightthickness=1)
    ...
    def create_right_panel(self, parent):
        ...
        score_box = tk.LabelFrame(right,text="Очки",padx=5,pady=5,bg=PANEL_COLOR,fg=DARK_GREEN,highlightbackground="#bbf7d0",highlightthickness=1)
